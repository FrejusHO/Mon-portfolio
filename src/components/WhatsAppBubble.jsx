...
const WhatsAppBubble = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-neonGreen text-white p-4 rounded-full shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-300 group flex items-center justify-center"
